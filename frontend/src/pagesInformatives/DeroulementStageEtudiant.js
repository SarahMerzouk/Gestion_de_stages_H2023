...
import "./styles/deroulementStageEtudiant.css";
        ...
        <div>
            ...
            <h2 className="titre">Directives pour les étudiants</h2>
                <div className="section">
                    <h4 className="titre">Tâches à effectuer par l'étudiant à la session d'automne  (c'est-à-dire maintenant):</h4>
                        ...
                        CV que vous devez remettre au coordonnateur des stages (Sylvain Labranche).</li>
                            ...
                            <p className="infos">{">>> "} En format "Word" ou en format PDF que vous allez remettre sur Moodle pour le cours "2018-2019 : Stages de fin d'études en informatique".
                        ...
                        <li className="number">Contacter les employeurs pour leur proposer vos services</li>
                            <p className="infos">{">>> "} Pour chaque employeur que vous contactez vous devez inscrire
                            ses coordonnées sur le formulaire <a href="../documents/contact_employeurs.pdf" /></p>
                        
                            <p className="infos">{">>> "}Fichier en format <a href="../documents/contact_employeurs.docx">Word.</a></p>
                        
                        <li className="number">Lorsque vous rencontrez un employeur (entrevue) vous devez remplir le formulaire 
                        <a href="../documents/rencontre_employeur.pdf">&laquo;rencontre&nbsp;employeur&raquo;</a>.</li>
                            <p className="infos">{">>> "} Fichier en format <a href="../documents/rencontre_employeur.docx">Word.</a></p>
                        
                        <li className="number">Vous devez rencontrer au moins trois (3) employeurs, à moins bien sûr que vous ayez 
                        trouvé votre stage avant. Vous devriez avoir au moins trois formulaires &laquo;rencontre&raquo;, 
                        un par employeur rencontré.</li>

                        <li className="number">Au plus tard le vendredi 2 novembre à 12h00: remettre vos formulaires &laquo;contact&nbsp;employeurs&raquo; et 
                        &laquo;rencontre&nbsp;employeur&raquo; remplis:
                            ...
                            et &laquo;rencontre&raquo; en format Word)</li>
                            <p className="infos">{">>> "} insi le 2 novembre, vous devriez avoir trouvé votre stage.</p>
                </div>
                ...
                <div className="section">
                    ...
                    <p>TRÈS IMPORTANT: pour toute communication par courriel avec le coordonnateur
                        vous devez inscrire dans le sujet du message:</p>  
                ...
                <div className="section">
                    ...
                    <p>Les stages ont lieu durant la session d'hiver.
                    ...
                    informatique, les dates et les spécificités des stages".</p>
                    
                    <p>Le stagiaire est tenu de respecter l'horaire  
                    ...
                    professeur-superviseur).</p>

                    <p>Pendant les journées pédagogiques et les journées
                    ...
                    premier lundi de janvier de l'année du stage)</p>
                    
                    <p>Il y aura deux rencontres obligatoires en ligne
                    Vendredi 12h00-13h00 en janvier avant le début des stages.
                    Vendredi 12h00-13h00 vers le milieu du stage 
                    (la date sera communiquée plus tard).</p>
                    
                    <p>Les étudiants doivent remettre un rapport hebdomadaire 
                    ...
                    sera discuté avec le professeur superviseur de l'étudiant.</p>
                    
                    <p>Le professeur superviseur contactera l'étudiant (selon l'horaire
                    ...
                    particulière avec le superviseur de l'entreprise).</p>
                    
                    <p>À la fin des stages (habituellement dans la semaine
